...
if __name__ == '__main__':
    ...
    block_six_side = ImageTk.PhotoImage(Image.open("Images/6_block.png").resize((33, 33),  Image.Resampling.LANCZOS))
    block_five_side = ImageTk.PhotoImage(Image.open("Images/5_block.png").resize((33, 33),  Image.Resampling.LANCZOS))
    block_four_side = ImageTk.PhotoImage(Image.open("Images/4_block.png").resize((33, 33),  Image.Resampling.LANCZOS))
    block_three_side = ImageTk.PhotoImage(Image.open("Images/3_block.png").resize((33, 33),  Image.Resampling.LANCZOS))
    block_two_side = ImageTk.PhotoImage(Image.open("Images/2_block.png").resize((33, 33),  Image.Resampling.LANCZOS))
    block_one_side = ImageTk.PhotoImage(Image.open("Images/1_block.png").resize((33, 33),  Image.Resampling.LANCZOS))
